...
<head>
	...
	<link rel="stylesheet" href="<?=base_url()?>assets/css/angular-moment-picker.min.css">
	...
	<!-- MY APP -->
	<script src="<?=base_url()?>App/route.js?<?=rand()?>"></script>

	<!-- APP CONTROLLER -->
	<script src="<?=base_url()?>App/ItemController.js?<?=rand()?>"></script>
